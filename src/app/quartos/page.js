...
const quartos = [
  {
    ...
    infoCompleta: [
      ...
      'Almoço: Inclui pequeno-almoço continental',
      'Preço: R$ 240.00',
      'Pagamento: Não é necessário um pré-pagamento – pague no alojamento',
  ...
  },
  {
    ...
    camas: 1,
    preco: 'R$ 270.00',
    descricao: `A suíte dispõe de 1 quarto e 1 casa de banho com duche e produtos de higiene pessoal gratuitos. Apresentando uma varanda com vista para o jardim, esta suíte também oferece minibar e TV de ecrã plano. Camas confortáveis, 8.9 – Com base em 11 comentários.`,
    infoCompleta: [
      'Capacidade: 2 hóspedes',
  ...
  },
  {
    ...
    camas: 2,
    preco: 'R$ 650.00',
    descricao: `O quarto triplo oferece minibar, área de estar, varanda com vista jardim, além de casa de banho privativa com duche. A unidade dispõe de 2 camas. Camas confortáveis, 8.9 – Com base em 11 comentários.`,
    infoCompleta: [
